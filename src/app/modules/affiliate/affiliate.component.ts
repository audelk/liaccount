...
export class AffiliateComponent implements OnInit {
  ...
  list() {
    let that = this;
    that.userSvc.appiCall(UserService.actions[that.objectName + "ListVIP"],{userID:this.uID}).subscribe(res => {
      that.res = res;
  ...
  listLinks() {
    let that = this;
    that.userSvc.appiCall(UserService.actions[that.objectName + "LinkListVIP"],{userID:this.uID}).subscribe(res => {
  ...
  getNewCode(){
    let that = this;
    that.userSvc.appiCall(UserService.actions[that.objectName + "LinkNewVIP"],{userID:this.uID}).subscribe(res => {
